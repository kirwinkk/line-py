                ...
                if msg.text != None:
                    if msg.toType == 2:
                        ...
                        if may in str(msg.contentMetadata):
                            ...
                            client.sendMessage(msg.to, str(rslt))
                        else:
                            pass
                    else:
                        pass
                    ...
                    if msg.contentType == 0:
                        if msg.toType == 2:
                            ...
                            if text.lower() == 'me':
                                ...
                                client.sendMessage(receiver, "%s sec" % (elapsed_time))
                                ...
                                if msg.to in cctv['point']:
                                    ...
                                    client.sendMessage(msg.to, cctv['sidermem'][msg.to])
                                else:
                                    client.sendMessage(msg.to, "尚未[/set]")
                except Exception as e:
                        ...
                        if op.param1 in cctv['point']:
                            ...
                            if Name in cctv['sidermem'][op.param1]:
                                ...
                                if " " in Name:
                                    nick = Name.split(' ')
                                    if len(nick) == 2:
                                        client.sendMessage(op.param1, '[偵測已讀]\n'+nick[0])
                                    else:
                                        client.sendMessage(op.param1, '[偵測已讀]\n'+nick[1])
                                else:
                                    client.sendText(op.param1, '[偵測已讀]\n'+Name)
                        else:
                            pass
                    else:
                        pass
